...
struct MdSeg {
    enum Type { NORMAL, BOLD, ITALIC, STRIKETHROUGH, CODE, HEADING, LINK, IMAGE, TABLE_ROW, TABLE_SEP, BLOCKQUOTE, HR, LIST_ITEM, TASK_DONE, TASK_PENDING, MATH, DISPLAY_MATH,
